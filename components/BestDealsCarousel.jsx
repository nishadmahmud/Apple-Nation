  ...
  return (
    <section className="space-y-8 mt-24">
      <div className="flex flex-col gap-3 text-center lg:text-left">
        <div className="inline-flex items-center justify-center gap-2 self-center rounded-full bg-emerald-500/10 border border-emerald-500/20 px-5 py-2 text-sm font-bold uppercase tracking-wide text-emerald-600 dark:bg-emerald-400/10 dark:text-emerald-400 dark:border-emerald-400/20 lg:self-start">
          Best Deals
        </div>
            ...
            return (
              ...
              >
                <div className="relative h-48 w-full overflow-hidden rounded-2xl bg-slate-50 dark:bg-zinc-800/50">
                  ...
                  />
                  {deal.discount ? (
                    <div className="absolute left-0 top-4 rounded-r-full bg-emerald-500 px-4 py-1.5 text-xs font-bold text-white shadow-lg shadow-emerald-500/30">
                ...
                <div className="space-y-3 px-2">
                  <h3 className="text-lg font-bold text-slate-900 line-clamp-2 dark:text-zinc-100 group-hover:text-emerald-600 transition-colors">
                    {deal.name}
                  </h3>
                ...
                <div className="mt-auto flex items-end justify-between px-2 pb-2">
                  ...
                  <Link
                    ...
                    className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-slate-900 text-white transition-all duration-300 hover:bg-emerald-600 hover:scale-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-emerald-500 dark:hover:text-white"
