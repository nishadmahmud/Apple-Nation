...
export default function TrustBanner() {
  return (
    <section className="space-y-8 font-urbanist md:mt-16 mt-10 md:rounded-3xl bg-white p-6 rounded-xl shadow-xl shadow-slate-900/5 backdrop-blur-sm dark:bg-zinc-900/70 sm:space-y-10 sm:p-8 lg:space-y-12 lg:p-10">
      ...
      <div className="grid gap-4 md:gap-6 md:grid-cols-2">
        {trustHighlights.map((item) => (
          <div
            key={item.title}
            className="flex gap-3 md:rounded-2xl rounded-lg border border-slate-200 bg-slate-50 p-4 transition-transform duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-slate-900/10 dark:border-zinc-800 dark:bg-zinc-950/40 dark:hover:shadow-zinc-900/30 sm:gap-4 sm:p-6"
          >
      ...
      <div className="flex flex-col items-center justify-between gap-4 md:rounded-2xl rounded-lg bg-linear-to-r from-slate-900 via-slate-800 to-slate-900 px-4 py-6 text-center text-white dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-900 sm:flex-row sm:gap-6 sm:px-6 sm:py-8 sm:text-left">
